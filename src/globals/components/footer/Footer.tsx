...
const Footer = () => {
  return (
    <>
      <footer className="bg-gray-900 text-white py-12 px-4 font-sans tracking-wide mt-auto">
        <div className="text-center">
          ...
          <p className="text-base text-gray-300">© Sajha Pasal. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
